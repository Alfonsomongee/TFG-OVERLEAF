...
## CAPÍTULO 9: `docs/09-conclusiones.mdx`

### 9.1 NO TOCAR la estructura principal
El capítulo es excelente. Solo una adición menor.

### 9.2 Añadir 5ª línea de investigación
Al final de la lista de líneas de investigación (~L88), añadir:
```
...
## CAPÍTULO 10: `docs/10-resumen-de-cifras.mdx`

### 10.1 Aclarar generación vs demanda
Buscar (~L30): `eliminaron ~2.500 MW de capacidad de generación de una red peninsular que operaba con una demanda de ~29,6 GW`
Reemplazar por: `eliminaron ~2.500 MW de capacidad de generación de una red peninsular que despachaba ~29,6 GW de generación frente a ~25,2 GW de demanda neta`

---

## IMPACTO SOCIAL: `docs/impacto-social.mdx`

### IS.1 CT9: Añadir párrafo de cierre
ANTES del bloque `:::info Fuentes primarias`, añadir:
```mdx
...
### IS.2 Corregir sidebar_position
Cambiar `sidebar_position: 9` por `sidebar_position: 7.7` para evitar colisión con cap. 9 (Conclusiones).

---

## GLOSARIO: `docs/glosario.mdx`

### GL.1 Añadir título y contexto
El archivo actual solo tiene `<GlosarioTecnico />`. Añadir encima:
```mdx
