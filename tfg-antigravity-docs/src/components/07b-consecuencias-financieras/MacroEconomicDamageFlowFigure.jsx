  ...
  return (
    <figure className={styles.figure}>
      ...
      <figcaption className={styles.caption}>
        Figura 35. Del cero de tensión a la factura macroeconómica. Cadena causal que transforma
        el colapso eléctrico en energía no suministrada, pérdida de conectividad y daño económico agregado.
        Las estimaciones CEOE y ATA se muestran como perímetros de impacto distintos, no como magnitudes aditivas.
        Elaboración propia a partir de Funcas, CEOE, ATA, Cloudflare Radar, Ookla y referencias ACER/CEER sobre VoLL.
      </figcaption>
    </figure>
  );
}
