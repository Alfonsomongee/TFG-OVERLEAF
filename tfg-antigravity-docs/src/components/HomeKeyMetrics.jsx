  ...
  es: {
    ...
    metrics: [
      ...
      },
      {
        ...
        detail: 'Esquemas de defensa por subfrecuencia · incluye >2.000 MW de bombeo hidráulico',
      ...
      },
      {
        ...
        detail: 'Hasta suministro prácticamente restituido (07:05 del 29-A)',
  ...
  en: {
    ...
    metrics: [
      ...
      },
      {
        ...
        detail: 'Under-frequency defense schemes · includes >2,000 MW of pumped hydro',
      ...
      },
      {
        ...
        detail: 'Until supply practically restored (07:05 on Apr 29)',
        source: 'REE / REN / ENTSO-E',
      },
    ],
  },
  de: {
    ...
    metrics: [
      ...
      },
      {
        ...
        detail: 'Unterfrequenz-Schutzschemas · inkl. >2.000 MW Pumpspeicher',
      ...
      },
      {
        ...
        detail: 'Bis zur praktisch vollständigen Wiederherstellung (07:05 Uhr am 29.04.)',
        source: 'REE / REN / ENTSO-E',
      },
    ],
  },
  'zh-Hans': {
    ...
    metrics: [
      ...
      },
      {
        ...
        detail: '欠频防御保护方案 · 含 >2000 MW 抽水蓄能',
        source: '政府分析委员会（2025）',
      },
      {
        id: 'restoration',
