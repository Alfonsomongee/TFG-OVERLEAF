...
const THEMATIC_DATA_EN = [
  {
    ...
    items: [
      { label: 'Evolution of the generation mix 2010 vs 2024',          type: 'Figure',      href: '/docs/anexo-demanda-generacion-balance#fig-mix_comparativo_2010_2024' },
      { label: 'Installed capacity as of January 31, 2025',             type: 'Figure',      href: '/docs/anexo-demanda-generacion-balance#fig-capacidad_instalada_2025' },
      { label: 'Generation profile on April 28 at 12:30 CEST',           type: 'Figure',      href: '/docs/anexo-demanda-generacion-balance#fig-ree_generation_mix_28april' },
      { label: 'Technological mix during re-energization',            type: 'Figure',      href: '/docs/anexo-demanda-generacion-balance#fig-evolucion_mix_reenergizacion' },
      { label: 'Technological breakdown of the mix at 12:30 CEST',        type: 'Table',       href: '/docs/anexo-demanda-generacion-balance#tabla-mix-generacion-12-30' },
      { label: 'Unavailable power by technology',                  type: 'Table',       href: '/docs/anexo-demanda-generacion-balance#tabla-indisponibilidad-generacion-convencional' },
      { label: 'OMIE marginal prices April 28 vs 29',                 type: 'Table',       href: '/docs/anexo-demanda-generacion-balance#tabla-precios-marginales-omie' },
      { label: 'International exchange schedule pre-blackout',  type: 'Table',       href: '/docs/anexo-demanda-generacion-balance#tabla-programa-intercambios-pre-apagon' },
      { label: 'Forecast vs. real demand Spain April 28',                 type: 'Table',       href: '/docs/anexo-demanda-generacion-balance#tabla-spanish-demand-forecast' },
      { label: 'Forecast vs. real demand Portugal April 28',              type: 'Table',       href: '/docs/anexo-demanda-generacion-balance#tabla-portuguese-demand-forecast' },
      { label: 'Installed vs. unavailable capacity by technology',    type: 'Table',       href: '/docs/anexo-demanda-generacion-balance#tabla-unavailable-capacity' },
      { label: 'Peninsular Demand — actual vs. scheduled vs. forecast',  type: 'Series',       href: '/docs/anexo-demanda-generacion-balance#chart-1' },
      { label: 'Total Load ES + PT (hourly MTU)',                     type: 'Series',       href: '/docs/anexo-demanda-generacion-balance#chart-2' },
      { label: 'Production Program — market breakdown',       type: 'Series',       href: '/docs/anexo-demanda-generacion-balance#chart-3' },
      { label: 'Installed Capacity per Type — 121,873 MW',            type: 'Series',       href: '/docs/anexo-demanda-generacion-balance#chart-5' },
      { label: 'Water Reservoirs & Hydro — 15 TWh',                   type: 'Series',       href: '/docs/anexo-demanda-generacion-balance#chart-7' },
      { label: 'CO₂ + Renewables — 91.2% at 11:30 CEST',         type: 'Series',       href: '/docs/anexo-demanda-generacion-balance#chart-8' },
      { label: 'Energy transition and CO₂ emissions',               type: 'Interactive', href: '/docs/anexo-demanda-generacion-balance#grafico-streamgraph' },
      { label: 'Real-time generation mix',                     type: 'Interactive', href: '/docs/anexo-demanda-generacion-balance#grafico-mix-generacion' },
      { label: 'Emissions vs. renewable penetration',                   type: 'Interactive', href: '/docs/anexo-demanda-generacion-balance#grafico-emissions-renewables' },
    ]
  },
  {
    id: 'T2',
    ...
    items: [
      { label: 'Displacement of rotating masses by IBR (FutuRed)',  type: 'Figure',      href: '/docs/anexo-estabilidad-dinamica-tension#fig-futured_grid_evolution' },
      { label: 'Oscillations in Núñez de Balboa — April 22',        type: 'Figure',      href: '/docs/anexo-estabilidad-dinamica-tension#fig-precursor_overvoltage_22april' },
      { label: 'Frequency and voltage in Carmona during the collapse',   type: 'Figure',      href: '/docs/anexo-estabilidad-dinamica-tension#fig-frequency_voltage_carmona' },
      { label: 'Voltages in Núñez de Balboa — April 22, 24, and 28', type: 'Figure',      href: '/docs/anexo-estabilidad-dinamica-tension#fig-nunez_balboa_precursores' },
      { label: '0.6 Hz oscillation detected by WAMS (12:03 CEST)',   type: 'Figure',      href: '/docs/anexo-estabilidad-dinamica-tension#fig-wams_oscilaciones_carmona' },
      { label: 'Coupled voltage-frequency evolution Phase 3',         type: 'Figure',      href: '/docs/anexo-estabilidad-dinamica-tension#fig-tension_frecuencia_colapso' },
      { label: '400 kV voltage cartography (12:30–12:32:57) — REE', type: 'Figure',     href: '/docs/anexo-estabilidad-dinamica-tension#fig-mapas_termicos_tension_ree' },
      { label: 'Q-V stability curves at Carmona 400 kV',         type: 'Figure',      href: '/docs/anexo-estabilidad-dinamica-tension#fig-fluctuaciones_tension_previas' },
      { label: 'Reactive power balance at 12:30 CEST',       type: 'Figure',      href: '/docs/anexo-estabilidad-dinamica-tension#fig-asimetria_balance_reactiva_sur' },
      { label: 'System inertia H_tot (2.21–2.71 s)',              type: 'Table',       href: '/docs/anexo-estabilidad-dinamica-tension#tabla-inercia-sistema-htot' },
      { label: 'Identified oscillatory modes (0.2–0.63 Hz)',       type: 'Table',       href: '/docs/anexo-estabilidad-dinamica-tension#tabla-modos-oscilatorios' },
      { label: 'Frequency and RoCoF — 27 critical seconds',           type: 'Table',       href: '/docs/anexo-estabilidad-dinamica-tension#tabla-evolucion-frecuencia-rocof' },
      { label: 'Voltages at critical nodes during the cascade',       type: 'Table',       href: '/docs/anexo-estabilidad-dinamica-tension#tabla-tensiones-nudos-criticos' },
      { label: 'Reactive compensation maneuvers executed by REE',type: 'Table',       href: '/docs/anexo-estabilidad-dinamica-tension#tabla-maniobras-compensacion-reactiva' },
      { label: 'Anomalous reactive injection from distribution',        type: 'Table',       href: '/docs/anexo-estabilidad-dinamica-tension#tabla-inyeccion-reactiva-distribucion' },
      { label: 'Demand variation due to DG disconnection (~700 MW)', type: 'Table',       href: '/docs/anexo-estabilidad-dinamica-tension#tabla-variacion-demanda-desconexion-gd' },
      { label: 'Available Power by Technology (early morning April 28)',  type: 'Series',       href: '/docs/anexo-estabilidad-dinamica-tension#chart-4' },
      { label: 'Actual Generation per Unit — real mix at collapse',     type: 'Series',       href: '/docs/anexo-estabilidad-dinamica-tension#chart-6' },
      { label: 'Frequency drop during collapse',               type: 'Interactive', href: '/docs/anexo-estabilidad-dinamica-tension#grafico-frequency' },
      { label: 'Collapse seismograph — Carmona 400 kV',             type: 'Interactive', href: '/docs/anexo-estabilidad-dinamica-tension#grafico-sismograph' },
      { label: 'Transient phasor plot — PMU divergence',       type: 'Interactive', href: '/docs/anexo-estabilidad-dinamica-tension#grafico-phasor' },
    ]
  },
  {
    id: 'T3',
    ...
    items: [
      { label: 'Collapse sequence — Operator vs. Automatic Actions (Albustami)', type: 'Figure', href: '/docs/anexo-cascada-protecciones-desconexiones#fig-albustami_ieee39_secuencia' },
      { label: 'Tap-Lag Effect — 400 kV / collector decoupling',   type: 'Figure',      href: '/docs/anexo-cascada-protecciones-desconexiones#fig-tap_lag_decoupling' },
      { label: 'Overvoltage propagation Phase 2 (12:32–12:33)',   type: 'Figure',      href: '/docs/anexo-cascada-protecciones-desconexiones#fig-heatmap_propagation' },
      { label: 'Geographical propagation of the cascade — Phase 3',       type: 'Figure',      href: '/docs/anexo-cascada-protecciones-desconexiones#fig-cascada_desconexiones' },
      { label: 'Oscillogram of the root trip in Granada (12:32:56)',   type: 'Figure',      href: '/docs/anexo-cascada-protecciones-desconexiones#fig-aluvion_alertas_sobretension_sur' },
      { label: 'Generation disconnection sequence — southwestern zone', type: 'Table',    href: '/docs/anexo-cascada-protecciones-desconexiones#tabla-secuencia-desconexion-suroeste' },
      { label: 'Applied UFLS steps (49.5 → 48.0 Hz)',           type: 'Table',       href: '/docs/anexo-cascada-protecciones-desconexiones#tabla-escalones-ufls' },
      { label: 'Nuclear power plants status during the collapse',     type: 'Table',       href: '/docs/anexo-cascada-protecciones-desconexiones#tabla-estado-centrales-nucleares' },
      { label: 'Hydroelectric pumping disconnection',                     type: 'Table',       href: '/docs/anexo-cascada-protecciones-desconexiones#tabla-desconexion-bombeo-hidraulica' },
      { label: 'Pumping disconnected in Spain (~2,756 MW)',            type: 'Table',       href: '/docs/anexo-cascada-protecciones-desconexiones#tabla-pump-storage-es' },
      { label: 'Pumping disconnected in Portugal (~2,098 MW)',          type: 'Table',       href: '/docs/anexo-cascada-protecciones-desconexiones#tabla-pump-storage-pt' },
      { label: 'Demand disconnection by distributor (DSO)',       type: 'Table',       href: '/docs/anexo-cascada-protecciones-desconexiones#tabla-dso-load-shedding' },
      { label: 'Protection events during the cascade',             type: 'Table',       href: '/docs/anexo-cascada-protecciones-desconexiones#tabla-eventos-proteccion-maniobras' },
      { label: 'Demand disconnected in Spain — 8,505 MW (33.8%)',  type: 'Table',       href: '/docs/anexo-cascada-protecciones-desconexiones#tabla-demand-shedding-es' },
      { label: 'Demand disconnected in Portugal — 1,955 MW (33.3%)',type: 'Table',       href: '/docs/anexo-cascada-protecciones-desconexiones#tabla-demand-shedding-pt' },
      { label: 'Combined summary of disconnected load ES + PT',         type: 'Table',       href: '/docs/anexo-cascada-protecciones-desconexiones#tabla-load-shedding-es-pt' },
      { label: 'SPOT vs. PVPC — price evolution April 28–29',     type: 'Series',       href: '/docs/anexo-cascada-protecciones-desconexiones#chart-9' },
      { label: 'Final Price Breakdown — 00:00 CEST April 28',     type: 'Series',       href: '/docs/anexo-cascada-protecciones-desconexiones#chart-10' },
      { label: 'Energy Prices Europe — ES and PT April 28–29',          type: 'Series',       href: '/docs/anexo-cascada-protecciones-desconexiones#chart-11' },
      { label: 'Real-time Deviation Prices (€/MWh)',           type: 'Series',       href: '/docs/anexo-cascada-protecciones-desconexiones#chart-12' },
      { label: 'Animated map of the collapse — geographical propagation',   type: 'Interactive', href: '/docs/anexo-cascada-protecciones-desconexiones#grafico-map' },
      { label: 'Incident timeline',                              type: 'Interactive', href: '/docs/anexo-cascada-protecciones-desconexiones#grafico-timeline' },
      { label: 'ANSI 59 cascade loop — positive feedback',     type: 'Interactive', href: '/docs/anexo-cascada-protecciones-desconexiones#grafico-ansi59' },
      { label: 'Anatomy of the collapse — 30 seconds',                  type: 'Interactive', href: '/docs/anexo-cascada-protecciones-desconexiones#grafico-sticky-collapse' },
      { label: 'UFLS paradox',                                    type: 'Interactive', href: '/docs/anexo-cascada-protecciones-desconexiones#grafico-ufls' },
      { label: 'Tap-Lag mechanism — 5 steps',                         type: 'Interactive', href: '/docs/anexo-cascada-protecciones-desconexiones#grafico-tap-lag-sequence' },
      { label: 'Grid unavailability of the 400 kV transmission network',     type: 'Interactive', href: '/docs/anexo-cascada-protecciones-desconexiones#grafico-grid-unavailability' },
    ]
  },
  {
    id: 'T4',
    ...
    items: [
      { label: 'Deviation of NTC vs. actual physical flow — ES-FR border', type: 'Figure',      href: '/docs/anexo-interconexiones-flujos#fig-entsoe_flow_deviation' },
      { label: 'INELFE-1 PMODE3 → PMODE1 transition (12:08 CEST)', type: 'Figure',     href: '/docs/anexo-interconexiones-flujos#fig-hvdc_control_transition' },
      { label: 'Reversal of Pyrenean flows during Phase 3',        type: 'Figure',      href: '/docs/anexo-interconexiones-flujos#fig-interconexion_francia_colapso' },
      { label: 'Cross-border support from France in the restoration', type: 'Figure',   href: '/docs/anexo-interconexiones-flujos#fig-evolucion_carga_repuesta_francia' },
      { label: 'Top-Down support from Morocco (ONEE)',              type: 'Figure',      href: '/docs/anexo-interconexiones-flujos#fig-intercambio_marruecos_topdown' },
      { label: 'HVDC Santa Llogaia–Baixas — operating parameters',   type: 'Table',       href: '/docs/anexo-interconexiones-flujos#tabla-hvdc-santa-llogaia-parametros' },
      { label: 'International exchanges minute-by-minute T-30/T+30', type: 'Table',    href: '/docs/anexo-interconexiones-flujos#tabla-intercambios-internacionales-minuto' },
      { label: 'Topological maneuvers of Red Eléctrica',               type: 'Table',       href: '/docs/anexo-interconexiones-flujos#tabla-re-topological-manoeuvres' },
      { label: 'Border Net Flows P48 — ES-FR, ES-PT, ES-MA, ES-AD', type: 'Series',     href: '/docs/anexo-interconexiones-flujos#chart-13' },
      { label: 'Cross-Border Physical Flows — ES-FR and ES-PT',          type: 'Series',       href: '/docs/anexo-interconexiones-flujos#chart-14' },
      { label: 'Scheduled Commercial Exchanges — ES-FR and ES-PT',       type: 'Series',       href: '/docs/anexo-interconexiones-flujos#chart-15' },
      { label: 'Explicit Capacity Auctions — ES-FR and ES-PT',     type: 'Series',       href: '/docs/anexo-interconexiones-flujos#chart-16' },
      { label: 'Forecast Transfer Capacities — April 28–29',           type: 'Series',       href: '/docs/anexo-interconexiones-flujos#chart-17' },
      { label: 'Topology of the Iberian transmission network',             type: 'Interactive', href: '/docs/anexo-interconexiones-flujos#grafico-topology' },
      { label: 'International interconnections dashboard',          type: 'Interactive', href: '/docs/anexo-interconexiones-flujos#grafico-interconnection' },
    ]
  },
  {
    id: 'T5',
    ...
    items: [
      { label: 'OMIE marginal prices April 28 vs 29 (€/MWh)',        type: 'Table',       href: '/docs/anexo-mercado-costes#tabla-precios-marginales-omie' },
      { label: 'Current Balancing State — every 15 min April 28–29',   type: 'Series',       href: '/docs/anexo-mercado-costes#chart-18' },
      { label: 'Imbalance — Volume MW (every 15 min)',                 type: 'Series',       href: '/docs/anexo-mercado-costes#chart-19' },
      { label: 'Imbalance Prices (€/MWh)',                             type: 'Series',       href: '/docs/anexo-mercado-costes#chart-20' },
      { label: 'FRR Capacity — Reserves MW per quarter',             type: 'Series',       href: '/docs/anexo-mercado-costes#chart-21' },
      { label: 'Cost of Congestion Management — Spain 2025',          type: 'Series',       href: '/docs/anexo-mercado-costes#chart-22' },
      { label: 'Inaction cost matrix — OPEX vs. CAPEX',        type: 'Interactive', href: '/docs/anexo-mercado-costes#grafico-matrix' },
    ]
  },
  {
    id: 'T6',
    ...
    items: [
      { label: 'Topological fragmentation according to P.O. 1.6',        type: 'Figure',      href: '/docs/anexo-reposicion-blackstart#fig-islas_reposicion_entsoe' },
      { label: 'Dual strategy Top-Down (FR + MA) + Bottom-Up (hydro)', type: 'Figure',   href: '/docs/anexo-reposicion-blackstart#fig-estrategia_reenergizacion_dual' },
      { label: 'Hydraulic Black Start attempts — Phase 4',    type: 'Figure',      href: '/docs/anexo-reposicion-blackstart#fig-black_start_hidroelectrico' },
      { label: 'Collapse and recovery of peninsular demand',     type: 'Figure',      href: '/docs/anexo-reposicion-blackstart#fig-recuperacion_demanda_peninsular' },
      { label: 'Demand recovery Spain (0% → 99.95% in ~16 h)', type: 'Table',  href: '/docs/anexo-reposicion-blackstart#tabla-recuperacion-demanda-espana' },
      { label: 'Restoration times by geographical island',          type: 'Table',       href: '/docs/anexo-reposicion-blackstart#tabla-tiempos-restauracion-islas' },
      { label: 'Demand recovery in Portugal (~12 h)',          type: 'Table',       href: '/docs/anexo-reposicion-blackstart#tabla-recuperacion-portugal' },
      { label: 'Black Start plants activated',     type: 'Table',       href: '/docs/anexo-reposicion-blackstart#tabla-centrales-black-start' },
      { label: 'ENTSO-E EAS state changes (Normal → Blackout → Restoration)', type: 'Table', href: '/docs/anexo-reposicion-blackstart#tabla-eas-state-changes' },
      { label: 'Fall-backs and Emergency Protocols — Europe',      type: 'Series',       href: '/docs/anexo-reposicion-blackstart#chart-23' },
    ]
  },
  {
    id: 'T7',
    ...
    items: [
      { label: 'Estimated economic costs of the blackout (€200–4,500 M)', type: 'Table',     href: '/docs/anexo-impacto-resiliencia#tabla-costes-economicos' },
      { label: 'Comparison with historical European blackouts',         type: 'Table',       href: '/docs/anexo-impacto-resiliencia#tabla-comparativa-blackouts-historicos' },
      { label: 'Economic audit — financial cascade of the blackout',  type: 'Interactive', href: '/docs/anexo-impacto-resiliencia#grafico-waterfall' },
      { label: 'Sectoral resilience — recovery by sector',      type: 'Interactive', href: '/docs/anexo-impacto-resiliencia#grafico-sectorial-resilience' },
    ]
  },
  {
    id: 'T8',
    ...
    items: [
      { label: 'Representative coverage — institutional critical posture', type: 'Figure',  href: '/docs/anexo-comunicacion-fuentes#fig-collage_criticos' },
      { label: 'Representative coverage — posture favoring the official narrative', type: 'Figure', href: '/docs/anexo-comunicacion-fuentes#fig-collage_institucional' },
      { label: 'International coverage of the incident',                  type: 'Figure',      href: '/docs/anexo-comunicacion-fuentes#fig-collage_internacional' },
      { label: 'Citizen publications during the first hours',   type: 'Figure',      href: '/docs/anexo-comunicacion-fuentes#fig-collage_ciudadanos' },
      { label: 'Political leaders posts on X (72 h)',        type: 'Figure',      href: '/docs/anexo-comunicacion-fuentes#fig-collage_politicos' },
    ]
  },
  {
    id: 'T9',
    ...
    items: [
      { label: 'PMU coverage density for inter-area oscillations', type: 'Figure',   href: '/docs/anexo-metodologia-modelos-datos-vivos#fig-pmu_sensors_europe' },
      { label: 'Geographical evolution of 400 kV voltages prior to collapse (IIT-ICAI)', type: 'Figure', href: '/docs/anexo-metodologia-modelos-datos-vivos#fig-scr_iberia' },
      { label: 'Conventional synchronous units coupled daily', type: 'Figure',  href: '/docs/anexo-metodologia-modelos-datos-vivos#fig-conventionalunits' },
      { label: 'GFL (following) vs. GFM (forming) grid circuits',    type: 'Figure',      href: '/docs/anexo-metodologia-modelos-datos-vivos#fig-gfl_vs_gfm_circuit1' },
      { label: 'Hybrid BESS-GFM + synchronous compensators architecture (Hitachi)', type: 'Figure', href: '/docs/anexo-metodologia-modelos-datos-vivos#fig-hitachi_hybrid' },
      { label: 'Minimum system cost with explicit ERS remuneration', type: 'Figure',  href: '/docs/anexo-metodologia-modelos-datos-vivos#fig-coste_optimo_ers' },
      { label: 'P.O. 7.4 deadband — disabled the defense', type: 'Figure',     href: '/docs/anexo-metodologia-modelos-datos-vivos#fig-po74_banda_muerta' },
      { label: 'BESS-GFM revenue stacking (day-ahead, aFRR, inertia, FFR)', type: 'Figure',  href: '/docs/anexo-metodologia-modelos-datos-vivos#fig-ers_revenue_stacking' },
      { label: 'Comparison of conclusions by investigating entity', type: 'Table',      href: '/docs/anexo-metodologia-modelos-datos-vivos#tabla-comparativa-conclusiones-entidades' },
      { label: 'Compass Lexecon / INESC TEC matrix — 8 factors',      type: 'Table',       href: '/docs/anexo-metodologia-modelos-datos-vivos#tabla-compass-lexecon' },
      { label: 'GFM vs. GFL phase plane diagram',                  type: 'Interactive', href: '/docs/anexo-metodologia-modelos-datos-vivos#grafico-phaseplane' },
      { label: 'Swing equation simulator (H, ΔP, FFR)',       type: 'Interactive', href: '/docs/anexo-metodologia-modelos-datos-vivos#grafico-swing' },
      { label: 'P-V nose curve — voltage instability',            type: 'Interactive', href: '/docs/anexo-metodologia-modelos-datos-vivos#grafico-pvcurve' },
      { label: 'System Now vs. 28-A — real-time comparator',     type: 'Interactive', href: '/docs/anexo-metodologia-modelos-datos-vivos#grafico-comparador-28a' },
      { label: 'Systemic vulnerability radar — 5 axes',            type: 'Interactive', href: '/docs/anexo-metodologia-modelos-datos-vivos#grafico-radar-vulnerabilidad' },
    ]
  },
];
...
export default function AnnexConceptIndex() {
  ...
  const goTo = (href) => {
    if (typeof window !== 'undefined') {
      // adapt route for locales if necessary
      let targetHref = href;
      if (currentLocale !== 'es') {
        targetHref = `/${currentLocale}${href}`;
      }
