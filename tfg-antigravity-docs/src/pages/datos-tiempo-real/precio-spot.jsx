// src/pages/datos-tiempo-real/precio-spot.jsx
    ...
    >
      ...
      <div style={styles.page}>
        ...
        <div style={styles.header}>
          ...
          <GlitchTitle as="h1" className="glitch-page-title">Precio SPOT vs Demanda</GlitchTitle>
          <p style={styles.desc}>
            Relación entre el precio del mercado mayorista eléctrico y la demanda en tiempo real,
            situando el punto actual sobre la trayectoria del <strong>28 de abril de 2025</strong>,
            donde el precio cayó a <strong>−2,5 €/MWh</strong> por exceso de renovables.
          </p>
        </div>
        <PrecioSpotScatter />
      </div>
