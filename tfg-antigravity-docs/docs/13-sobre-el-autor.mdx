    ...
    <div className="author-grid">
      ...
      <div>
        ...
        <div className="author-cta">
          ...
          <a href="https://www.linkedin.com/in/alfonso-monge-diaz-angel-971941277/" target="_blank" className="btn-secondary">LinkedIn</a>
          <a href="https://github.com/alfonsomongee" target="_blank" className="btn-secondary">GitHub</a>
          <a href="/cv.pdf" target="_blank" className="btn-secondary">Descargar CV</a>
        </div>
      </div>
    </div>
  </div>
