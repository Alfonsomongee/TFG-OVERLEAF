...
<ForensicTable
  title="TABLA 2 | TABLA 2 | TABLA 13 | FACT-CHECK: MEDIOS CRÍTICOS CON LA GESTIÓN INSTITUCIONAL"
...
<ForensicTable
  title="TABLA 3 | TABLA 3 | TABLA 14 | FACT-CHECK: MEDIOS CON POSTURA FAVORABLE A LA NARRATIVA INSTITUCIONAL"
  source="Elaboración propia (contraste con informes periciales ENTSO-E / IIT-ICAI / REE)"
>
