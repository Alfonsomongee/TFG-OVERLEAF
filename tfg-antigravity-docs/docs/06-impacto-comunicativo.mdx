...
En 2025, el equivalente fue la **inobservabilidad de la red de 220 kV** por el fenómeno <GlossaryLink term="OLTC (On-Load Tap Changer)">Tap-Lag</GlossaryLink>: los OLTC de los transformadores, con sus retardos mecánicos intencionales, amplificaron la sobretensión hacia las redes colectoras mientras el SCADA de REE mostraba una tensión aparentemente normal en 400 kV. En ambos casos, el operador humano **no veía la amenaza real** hasta que era demasiado tarde.
