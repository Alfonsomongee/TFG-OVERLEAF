...
<h2 id="fase-0">Fase 0: la red debilitada y la maniobra de mallado</h2>
...
<h2 id="fase-1">Fase 1: pérdida de amortiguamiento y disparo raíz (12:32:57 CEST)</h2>
...
<h2 id="fase-2">Fase 2: el fenómeno Tap-Lag y el desacoplamiento de voltajes (12:32:57–12:33:18 CEST)</h2>
...
<h2 id="fase-3">Fase 3: el camino hacia el cero de tensión (12:33:18—12:33:29 CEST)</h2>
...
![Inversión de Flujos en Enlaces AC/DC](/figuras/interconexion_francia_colapso.png) _Inversión de flujos en la frontera pirenaica durante la Fase 3: importación de emergencia de hasta 4.609 MVAr por las líneas AC, extracción simultánea de 1.000 MW por el HVDC, y apertura por pérdida de sincronismo a las 12:33:21 CEST. Fuente: Comité de Análisis del Gobierno / REE._
...
<span id="t9"></span>
<h2 id="fase-4">Fase 4: fragmentación y reposición</h2>
La fragmentación posterior al apagón resultó en 7 islas eléctricas sin masa síncrona, imposibilitando el black start.

<span id="t10"></span>
Tras 18,5 horas se recuperó el suministro conectando carga desde Francia y Marruecos.
