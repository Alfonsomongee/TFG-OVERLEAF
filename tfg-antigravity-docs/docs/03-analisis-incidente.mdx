...
<ChartCard 
  fig="01" 
  title="Oscilaciones y Sobretensiones en Núñez de Balboa"
  dek="Tensiones registradas en Núñez de Balboa 400 kV durante los eventos precursores y el 28-A"
  source="IIT-ICAI"
  caption="La sucesión de picos de sobretensión evidencia el estrechamiento progresivo de los márgenes de control de potencia reactiva."
>
  <img src="/figuras/nunez_balboa_precursores.png" alt="Tensiones en Núñez de Balboa (400 kV)" />
</ChartCard>
...
<ChartCard 
  fig="02" 
  title="Captura Oscilográfica WAMS (0.6 Hz)"
  source="ENTSO-E / REE"
  caption="Registro del WAMS capturando la oscilación electromecánica de 0,6 Hz en Carmona (Sevilla) a las 12:03 CEST. Los sistemas WAMS permiten observar la dinámica continental con resolución de milisegundos."
>
  <img src="/figuras/wams_oscilaciones_carmona.png" alt="Registro WAMS" />
</ChartCard>
...
<ChartCard 
  fig="04" 
  title="Desacoplamiento Tap-Lag"
  source="ENTSO-E"
  caption="Desacoplamiento entre el primario de 400 kV y el secundario colector durante la Fase 2. Mientras el incremento de tensión en el lado de 400 kV se mantuvo en valores moderados, la inercia del OLTC amplificó el transitorio en el lado colector."
>
  <img src="/figuras/tap_lag_decoupling.png" alt="Desacoplamiento Tap-Lag" />
</ChartCard>
...
<ChartCard 
  fig="05" 
  title="Mapa de Calor: Propagación de Sobretensiones"
  source="Comité de Análisis del Gobierno / REE"
  caption="Propagación de las sobretensiones en la red de 400 kV durante la Fase 2 (12:32:00–12:33:18 CEST)."
>
  <img src="/figuras/heatmap_propagation.png" alt="Mapa de propagación de sobretensiones" />
</ChartCard>
...
<ChartCard 
  fig="07" 
  title="Cascada de Desconexiones IBR"
  source="Comité de Análisis del Gobierno"
  caption="Propagación geográfica de la cascada durante los once segundos de la Fase 3."
>
  <img src="/figuras/cascada_desconexiones.png" alt="Cascada de desconexiones" />
</ChartCard>
...
<ChartCard 
  fig="09" 
  title="Evolución Acoplada de Tensión y Frecuencia"
  source="Comité de Análisis del Gobierno"
  caption="El incremento de tensión por encima de 1,10 p.u. precede en el tiempo a la caída de frecuencia, confirmando que el colapso fue primariamente capacitivo, no inercial."
>
  <img src="/figuras/tension_frecuencia_colapso.png" alt="Tensión y frecuencia" />
</ChartCard>
...
<ChartCard 
  fig="10" 
  title="Inversión de Flujos en Enlaces AC/DC"
  source="Comité de Análisis del Gobierno / REE"
  caption="Inversión de flujos en la frontera pirenaica durante la Fase 3: importación de emergencia de hasta 4.609 MW por las líneas AC, extracción simultánea de 1.000 MW por el HVDC, y apertura por pérdida de sincronismo a las 12:33:21 CEST."
>
  <img src="/figuras/interconexion_francia_colapso.png" alt="Interconexión con Francia" />
</ChartCard>
