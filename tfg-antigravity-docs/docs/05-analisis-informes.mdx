...
Como respuesta directa, ENTSO-E ha consolidado en su Informe de Fase II la actualización del **NC RfG 2.0**, que prevé imponer el <GlossaryLink term="GFM (Grid-Forming)">_grid-forming_</GlossaryLink> como requisito obligatorio para todos los módulos no síncronos ≥ 1 MW:
