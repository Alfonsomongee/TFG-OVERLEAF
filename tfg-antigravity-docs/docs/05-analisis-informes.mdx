...
<ForensicTable 
  title="TABLA E1 | MULTI-FACTOR CAUSALITY MODEL"
...
<summary>
  <span>▶ Dossier REE: evidencia fotométrica, secuencia de 18 eventos y propuestas regulatorias (Tablas 5–6)</span>
</summary>
...
<ForensicTable 
  title="TABLA E2 | OFFICIAL EVENT SEQUENCE LOG"
...
<ForensicTable 
  title="TABLA E3 | PROPOSED REGULATORY AMENDMENTS"
  source="Redeia / REE"
>
...
<ForensicTable 
  title="TABLA E4 | NC RFG 2.0 (PROPOSED) REQUIREMENTS COMPARISON"
...
<ForensicTable 
  title="TABLA E5 | TECHNICAL CONSENSUS MATRIX"
...
<ForensicTable 
  title="TABLA E6 | TECHNICAL DIVERGENCE MATRIX"
  source="Elaboración propia"
>
...
Las simulaciones periciales del aporte capacitivo del mallado frente a la potencia de cortocircuito en nudos como Granada pueden explorarse en el [*Mapa Topológico Interactivo*](./anexo-interactivos#topology) (véase Figura E5).
