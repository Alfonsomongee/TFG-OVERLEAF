...
<ForensicTable 
  title="TABLA 4 | MULTI-FACTOR CAUSALITY MODEL"
...
![Mapas térmicos de tensión en la red de 400 kV en los instantes previos al disparo raíz](/figuras/mapas_termicos_tension_ree.png) _Figura 23. Mapas térmicos de tensión en red 400 kV (12:30–12:32:57 CEST). Fuente: Red Eléctrica (REE)._

### Secuencia oficial de eventos desencadenantes (REE)

<ForensicTable 
  title="TABLA 5 | OFFICIAL EVENT SEQUENCE LOG"
...
<ForensicTable 
  title="TABLA 6 | PROPOSED REGULATORY AMENDMENTS"
  source="Redeia / REE"
>
...
![Curvas Q-V en el nudo de Carmona 400 kV según el análisis pericial ICAI](/figuras/fluctuaciones_tension_previas.png) _Figura 24. Curvas Q-V de estabilidad de tensión en Carmona 400 kV (análisis ICAI). Las maniobras de mallado contrajeron el margen al colapso un 57 %. Fuente: IIT-ICAI / Compass Lexecon._
...
![Registro oscilográfico del disparo raíz en Granada a las 12:32:56.993 CEST](/figuras/aluvion_alertas_sobretension_sur.png) _Figura 25. Registro oscilográfico del disparo raíz en Granada (12:32:56.993 CEST). Tensión en secundario colector fase A ≈ 145 kV (>1,10 p.u.), invisible para el SCADA por efecto Tap-Lag. Fuente: IIT-ICAI / AELEC._
...
![Balance de potencia reactiva en la zona sur a las 12:30 CEST según IIT-ICAI](/figuras/asimetria_balance_reactiva_sur.png) _Figura 26. Balance de potencia reactiva en zona sur (12:30 CEST) — déficit neto: −0,6 GVAr. Fuente: IIT-ICAI / Compass Lexecon._
...
<ForensicTable 
  title="TABLA 7 | NC RFG 2.0 (PROPOSED) REQUIREMENTS COMPARISON"
...
_Figura 27. Topología de la red ibérica y propagación del colapso hasta la pérdida de sincronismo con Francia (12:33:21 CEST). Simulación interactiva de elaboración propia basada en ENTSO-E._
...
<ForensicTable 
  title="TABLA 8 | TECHNICAL CONSENSUS MATRIX"
...
<ForensicTable 
  title="TABLA 9 | TECHNICAL DIVERGENCE MATRIX"
  source="Elaboración propia"
>
...
Las simulaciones periciales del aporte capacitivo del mallado frente a la potencia de cortocircuito en nudos como Granada pueden explorarse en el [*Mapa Topológico Interactivo*](./anexo-interactivos#topology).
