...
<ForensicTable 
  title="TABLA 4 | TABLA 4 | TABLA 3 | MULTI-FACTOR CAUSALITY MODEL"
...
<ForensicTable 
  title="TABLA 5 | TABLA 5 | TABLA 4 | OFFICIAL EVENT SEQUENCE LOG"
...
<ForensicTable 
  title="TABLA 6 | TABLA 6 | TABLA 5 | PROPOSED REGULATORY AMENDMENTS"
  source="Redeia / REE"
>
...
<ForensicTable 
  title="TABLA 7 | TABLA 7 | TABLA 6 | NC RFG 2.0 (PROPOSED) REQUIREMENTS COMPARISON"
...
<ForensicTable 
  title="TABLA 8 | TABLA 8 | TABLA 7 | TECHNICAL CONSENSUS MATRIX"
...
<ForensicTable 
  title="TABLA 9 | TABLA 9 | TABLA 8 | TECHNICAL DIVERGENCE MATRIX"
  source="Elaboración propia"
>
