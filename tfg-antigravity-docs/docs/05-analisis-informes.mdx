...
<div className="telemetry-table-container forensic-table">
  <div className="telemetry-metadata">
    <div className="telemetry-header">MULTI-FACTOR CAUSALITY MODEL</div>
    <div>SOURCE: COMITÉ DE ANÁLISIS DEL GOBIERNO</div>
  </div>
...
<div className="telemetry-table-container forensic-table">
  <div className="telemetry-metadata">
    <div className="telemetry-header">OFFICIAL EVENT SEQUENCE LOG</div>
    <div>SOURCE: RED ELÉCTRICA (OS)</div>
    <div>TIME BASE: UTC+2 (CEST)</div>
  </div>
...
<div className="telemetry-table-container forensic-table">
  <div className="telemetry-metadata">
    <div className="telemetry-header">PROPOSED REGULATORY AMENDMENTS</div>
    <div>SOURCE: REDEIA</div>
  </div>
...
<div className="telemetry-table-container forensic-table">
  <div className="telemetry-metadata">
    <div className="telemetry-header">NC RFG 2.0 (PROPOSED) REQUIREMENTS COMPARISON</div>
    <div>SOURCE: ENTSO-E</div>
  </div>
...
<div className="telemetry-table-container forensic-table">
  <div className="telemetry-metadata">
    <div className="telemetry-header">TECHNICAL CONSENSUS MATRIX</div>
    <div>SOURCE: MULTIPLE (CROSS-VERIFIED)</div>
  </div>
...
<div className="telemetry-table-container forensic-table">
  <div className="telemetry-metadata">
    <div className="telemetry-header">TECHNICAL DIVERGENCE MATRIX</div>
    <div>SOURCE: MULTIPLE (CROSS-VERIFIED)</div>
  </div>
