...
Las simulaciones periciales del aporte capacitivo del mallado frente a la potencia de cortocircuito en nudos como Granada pueden explorarse en el [*Mapa Topológico Interactivo*](/docs/galeria-graficas#topology).
