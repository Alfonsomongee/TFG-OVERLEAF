...
<div className="telemetry-table-container forensic-table">
  <div className="telemetry-metadata">
    <div className="telemetry-header">INSTITUTIONAL NARRATIVE SYNTHESIS MATRIX</div>
    <div>SOURCE: FORENSIC COMPARATIVE ANALYSIS</div>
  </div>
...
<div className="telemetry-table-container forensic-table">
  <div className="telemetry-metadata">
    <div className="telemetry-header">ENERGY TRANSITION STRUCTURAL TRILEMMA</div>
    <div>SOURCE: STRUCTURAL ANALYSIS</div>
  </div>
