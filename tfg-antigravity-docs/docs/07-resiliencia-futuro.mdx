...
![Mapas de tensión en la red peninsular de 400 kV en la franja crítica previa al colapso](/figuras/scr_iberia.png) _Figura 28. Mapas de tensión en red 400 kV en franja crítica previa al colapso. Fuente: IIT-ICAI._
...
![Evolución del número de unidades síncronas convencionales acopladas entre las 12h y 13h](/figuras/conventionalunits.png) _Figura 29. Unidades síncronas convencionales acopladas diariamente (12-13h). La tendencia decreciente previa al 28-A refleja la expulsión sistemática por orden de mérito. Fuente: ENTSO-E._
...
<ForensicTable 
  title="TABLA 10 | INTERNATIONAL BLACKOUT REGULATORY RESPONSE TIMELINE"
...
_Figura 30. Diagrama de plano de fase: convergencia de inversores GFM vs GFL vs generador síncrono. Modelo: oscilador no lineal amortiguado (RK4). Visualización interactiva de elaboración propia._
</div>
...
![Arquitectura híbrida para la resiliencia sistémica en redes descarbonizadas](/figuras/hitachi_hybrid.png) _Figura 31. Arquitectura híbrida para la resiliencia sistémica (BESS-GFM + SynCons). Fuente: Hitachi Energy / FUTURED._
...
![Optimización tecno-económica de la resiliencia en sistemas dominados por IBR](/figuras/coste_optimo_ers.png) _Figura 32. Optimización tecno-económica de la resiliencia en sistemas dominados por IBR. Fuente: Julia Matevosyan (ESIG) / FUTURED._
...
La diferencia de velocidad de actuación entre el marco original y la nueva regulación puede comprobarse en el [*Simulador de Respuesta Droop Automática*](./anexo-interactivos#droop-response).
...
<details>
<summary style={{cursor:'pointer', userSelect:'none', padding:'0.75rem 1rem', background:'rgba(255,165,0,0.06)', border:'1px solid rgba(255,165,0,0.2)', borderRadius:'8px', fontSize:'0.9rem', color:'rgba(203,213,225,0.85)', listStyle:'none', display:'flex', alignItems:'center', gap:'0.5rem'}}>
  <span>▶ Tiers de cumplimiento NC RfG 2.0: potencias, requisitos y cronogramas (Tabla 18)</span>
</summary>
<div style={{marginTop:'1rem'}}>
