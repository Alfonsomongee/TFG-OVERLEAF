...
<div className="telemetry-table-container forensic-table">
  <div className="telemetry-metadata">
    <div className="telemetry-header">SHORT CIRCUIT RATIO (SCR) THRESHOLDS</div>
    <div>SOURCE: SYSTEM ENGINEERING STANDARDS</div>
  </div>
...
<div className="telemetry-table-container forensic-table">
  <div className="telemetry-metadata">
    <div className="telemetry-header">P.O. 7.4 REGULATORY FRAMEWORK COMPARISON</div>
    <div>SOURCE: BOE-A-2025-13076 / CNMC</div>
  </div>
...
<div className="telemetry-table-container forensic-table">
  <div className="telemetry-metadata">
    <div className="telemetry-header">NC RFG 2.0 (PROPOSED) COMPLIANCE TIERS</div>
    <div>SOURCE: ENTSO-E TG GFC</div>
  </div>
...
<div className="telemetry-table-container forensic-table">
  <div className="telemetry-metadata">
    <div className="telemetry-header">EIRGRID DS3 SERVICES - CORE PARAMETERS</div>
    <div>SOURCE: EIRGRID DS3 PROGRAMME</div>
  </div>
