...
<ForensicTable 
  title="TABLA I1 | SHORT CIRCUIT RATIO (SCR) THRESHOLDS"
...
<ForensicTable 
  title="TABLA I2 | INTERNATIONAL BLACKOUT REGULATORY RESPONSE TIMELINE"
...
_Figura I5 — Optimización tecno-económica de la resiliencia en sistemas dominados por IBR. La curva muestra que la minimización del coste total del sistema no coincide con la minimización del LCOE, sino que requiere internalizar el coste de los Servicios Esenciales de Confiabilidad (ERS) que las máquinas síncronas aportaban implícitamente. Fuente: Julia Matevosyan (ESIG) / FUTURED._
...
<ForensicTable 
  title="TABLA I3 | P.O. 7.4 REGULATORY FRAMEWORK COMPARISON"
  source="CNMC / REE"
>
...
The difference in actuation speed between the original framework and the new regulation can be verified in the [*Simulador de Respuesta Droop Automática*](./anexo-interactivos#droop-response).
...
<ForensicTable 
  title="TABLA I | NC RFG 2.0 (PROPOSED) COMPLIANCE TIERS"
...
El efecto del despliegue del Grid-Forming sobre la inercia del sistema puede evaluarse en la [*Simulación del Impacto del Grid-Forming*](./anexo-interactivos#gridforming-impact).
...
<ForensicTable 
  title="TABLA I5 | EIRGRID DS3 SERVICES - CORE PARAMETERS"
