...
_Figura 5. Perfil comparado de generación peninsular: escenario del 28-A a las 12:30 CEST frente a operación actual vía API de ESIOS. Datos: ESIOS / REE y Comité de Análisis. Visualización interactiva de elaboración propia._
