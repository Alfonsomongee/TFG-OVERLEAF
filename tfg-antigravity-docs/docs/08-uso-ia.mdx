...
<div className="telemetry-table-container forensic-table">
  <div className="telemetry-metadata">
    <div className="telemetry-header">LLM ASSISTANCE - OPERATIONAL FUNCTIONS</div>
    <div>SOURCE: RESEARCH METHODOLOGY LOG</div>
  </div>
...
<div className="telemetry-table-container forensic-table">
  <div className="telemetry-metadata">
    <div className="telemetry-header">LLM HEURISTIC FAILURE MODES</div>
    <div>SOURCE: RESEARCH VALIDATION LOG</div>
  </div>
