...
La maniobra combinó dos frentes simultáneos: una estrategia **Top-Down** (soporte externo desde Francia y Marruecos como referencia de tensión) y una estrategia **Bottom-Up** (arranque autónomo de centrales hidroeléctricas internas en Galicia, Asturias y la cuenca del Duero) ([*ver Mapa de Reposición interactivo*](/docs/galeria-graficas#map)).
