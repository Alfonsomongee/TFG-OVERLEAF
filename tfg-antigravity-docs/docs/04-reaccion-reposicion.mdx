...
_Cronograma oficial de fases según el Comité de Análisis del Gobierno._
...
- **12:36 CEST** — Notificación formal al resto de operadores europeos a través del
...
Con la práctica totalidad del parque generador compuesto por <GlossaryLink term="IBR">IBR</GlossaryLink> en modo <GlossaryLink term="GFL (Grid-Following)">_grid-following_</GlossaryLink> —tecnológicamente incapaces de generar una onda de tensión sin red externa estable—, la supervivencia y el reinicio del sistema recayeron exclusivamente sobre las máquinas síncronas con capacidad de <GlossaryLink term="Black Start">arranque autónomo</GlossaryLink>.
