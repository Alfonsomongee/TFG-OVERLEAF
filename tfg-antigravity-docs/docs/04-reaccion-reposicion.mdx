...
_Figura 18. Rampa de recuperación de la demanda peninsular (28 abril 13:07 CEST — 29 abril 07:05 CEST). Área apilada: generación propia reestablecida (verde-azul) e importación desde Francia (ámbar). Línea roja: porcentaje de recuperación respecto a la demanda prevista original. El punto 01:00 marca el momento en que España comenzó a exportar hacia Francia (−102 MW), señal de excedente de generación propia. Elaboración propia a partir de REE, ENTSO-E y Comité de Análisis del Gobierno._
