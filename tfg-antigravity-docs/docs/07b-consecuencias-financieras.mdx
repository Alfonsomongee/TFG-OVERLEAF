...
El colapso sistémico de la red eléctrica de la península ibérica, materializado el 28 de abril de 2025 a las 12:33 horas (CEST), representa uno de los eventos de disrupción de infraestructuras críticas más severos en la historia económica contemporánea de la Unión Europea. Con una pérdida instantánea de más de 25 GW de demanda peninsular (España: 25,2 GW + Portugal: ~5,8 GW), la desconexión abrupta de los sistemas de España y Portugal de la red síncrona continental, y la afectación directa a más de 55 millones de ciudadanos y la totalidad del tejido productivo peninsular, las ramificaciones de este suceso trascienden la fenomenología puramente electromecánica. 
...
A través del prisma de la economía de la energía y la auditoría de infraestructuras críticas, la premisa analítica fundamental que rige este documento demuestra que el coste del capital destinado a la resiliencia sistémica es órdenes de magnitud inferior a la destrucción de valor (OPEX sobrevenido, lucro cesante e indemnizaciones cruzadas) generada por la vulnerabilidad de la red.
...
<ForensicTable
  title="TABLA 15 | VoLL ESTIMATES BY SECTOR"
...
2. Lucro Cesante y Costes de Oportunidad (Estimados en 12 millones de euros): Si bien la interrupción neta del suministro en ciertos polígonos osciló entre las cuatro y las catorce horas, la inercia termodinámica de estos procesos es implacable. El encendido, precalentamiento y recalibración de las líneas de producción supuso, en términos prácticos, "pérdidas de varios días después", comprometiendo la capacidad de las factorías para cumplir con las entregas pautadas (Just-In-Time), e induciendo penalizaciones en los contratos de suministro internacionales.
...
Iberdrola estructuró una estrategia legal, eludiendo la vía contencioso-administrativa, para incardinar el conflicto en la jurisdicción civil ordinaria. Iberdrola argumentó con contundencia que las declaraciones públicas emanadas desde la cúpula directiva de REE resultaron inexactas, parciales e innecesariamente despectivas, construyendo una narrativa mediática que transfirió injustamente la responsabilidad del cero nacional a la gestión privada de la eléctrica, devaluando el prestigio de la compañía frente a sus accionistas y penalizando coyunturalmente su valor bursátil.
...
Desde una perspectiva de contabilidad analítica, la Operación Reforzada se ha erigido como un coste recurrente sin retorno patrimonial. Las propias estimaciones corporativas de Redeia cifraron el coste directo de este sobreesfuerzo en 711 millones de euros únicamente para los doce meses posteriores al incidente. *(Nota: 666 M€ es el coste acumulado hasta el 31 de marzo de 2026, verificado por REE en abril de 2026. Los 711 M€ son la estimación de Redeia para los doce meses completos posteriores al incidente.)* Sin embargo, auditorías externas desarrolladas por consultoras globales como PwC escalaron la magnitud real del daño sistémico, estimando un sobrecoste superior a los 1.000 millones de euros respecto al ejercicio 2024.
...
La radiografía forense del Gran Apagón del 28 de abril de 2025 trasciende la estricta naturaleza del incidente electromecánico para conformar un evento de cisma macroeconómico. El balance económico agregado confirma:

- La impacto financiero en el sector electrointensivo (>25 M€).
...
- La litigiosidad derivada y las multas coercitivas de la CNMC.
- El OPEX reaccionario superior a 711 millones de euros anuales mediante la quema de gas natural de la "Operación Reforzada".

Frente a la constante sobrecostes persistentes del sistema eléctrico, el esfuerzo inversor para la modernización integral del ecosistema (entre 3.000 y 3.500 M€ en CAPEX para Condensadores Síncronos y retrofitting del P.O 7.4) no debe ser conceptuado como un pasivo gubernamental, sino como un inversión en infraestructura crítica. Invertir ingentes capitales ex-ante en la robustez física y algorítmica de la red no solo es el seguro más barato imaginable, sino la prerrogativa absoluta para salvaguardar la soberanía industrial y asegurar el éxito irreversible de la transición energética.
...
<summary style={{cursor:'pointer', userSelect:'none', padding:'0.75rem 1rem', background:'rgba(255,165,0,0.06)', border:'1px solid rgba(255,165,0,0.2)', borderRadius:'8px', fontSize:'0.9rem', color:'rgba(203,213,225,0.85)', listStyle:'none', display:'flex', alignItems:'center', gap:'0.5rem'}}>
  <span>▶ Ver gráfico de cascada financiera (waterfall)</span>
</summary>
